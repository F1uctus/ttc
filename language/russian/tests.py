...
""",
        ...
        self.assertEqual(9, len(replicas))

    def test_replicas_count_2(self):
        replicas = extract_replicas(
            """
...
""",
        ...
        self.assertEqual(20, len(replicas))

    def test_replicas_count_3(self):
        replicas = extract_replicas(
            """
...
""",
        ...
        self.assertEqual(12, len(replicas))

    def test_replicas_count_4(self):
        replicas = extract_replicas(
            """
...
""",
        ...
        self.assertEqual(7, len(replicas))
...
""",
        ...
        self.assertListEqual(
            ...
            [str(r.speaker) for r in replicas],
        )

    def test_speakers_solzhenitsyn_ivan_denisovich(self):
        replicas = extract_speakers(
            """
Тут бак принесли, снег растапливать для раствора. Слышали от кого-то, будто двенадцать часов уже.
 — Не иначе как двенадцать, — объявил и Шухов. — Солнышко на перевале уже.
...
""",
        ...
        self.assertListEqual(
            ["Шухов", "кавторанг", "Шухов", "кавторанг", "Шухов", "кавторанг", "Павло"],
            [str(r.speaker) for r in replicas],
        )

    def test_speakers_sanderson(self):
        replicas = extract_speakers(
            """
