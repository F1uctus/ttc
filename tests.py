...
from ttc import extract_replicas
...
""", 'ru')
    ...
    def test_extract_phrases_2(self):
        replicas = extract_replicas("""
Никогда раньше ему не давали столь преднамеренно ужасных инструкций.
...
""", 'ru')
        self.assertEqual(len(replicas), 41)
...
Амарк снова сел, вид у него был глуповатый.
        ...
        self.assertEqual(len(replicas), 19)
